        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`px-5 py-2.5 rounded-full font-semibold text-sm transition-all duration-300 shadow-sm hover:shadow-md ${isAuthenticated
            ...
            >
              {isAuthenticated ? 'Sair do Sistema' : 'Acesso Restrito'}
            </button>
          </div>
        </div>
      </header>
            ...
            announcements.map((announcement) => (
              ...
              >
                ...
                <p className="text-slate-600 dark:text-slate-400 line-clamp-3 mb-8 flex-grow leading-relaxed transition-colors">
                 {DOMPurify.sanitize(announcement.content, { ALLOWED_TAGS: [] })}
                </p>
